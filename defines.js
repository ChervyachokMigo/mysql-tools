...
export const prepareDB = async (
	{ DB_USER, DB_PASSWORD, DB_HOST, DB_PORT, DATABASES }, 
...
export const add_model_names= (names, model) => mysql_actions.push({ names, model });

export const select_mysql_model = (action) => {
