...
const mail_contents = (connection) => {
    const model = (0, defines_1.define_model)(connection, 'mail_contents', {
        ...
        html: { type: core_1.DataTypes.TEXT('long'), allowNull: true },
        text: { type: core_1.DataTypes.TEXT('long'), allowNull: true },
        textAsHtml: { type: core_1.DataTypes.TEXT('long'), allowNull: true },
