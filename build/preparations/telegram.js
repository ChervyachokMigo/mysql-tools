...
exports.telegram_prepare = void 0;
const sended_map_1 = require("../models/telegram/sended_map");
const download_map_1 = require("../models/telegram/download_map");
const not_found_map_1 = require("../models/telegram/not_found_map");
const long_map_1 = require("../models/telegram/long_map");
const tg_file_1 = require("../models/telegram/tg_file");
const beatmap_id_1 = require("../models/beatmaps/beatmap_id");
const telegram_prepare = (telegram_connection, beatmap_connection) => {
...
exports.telegram_prepare = telegram_prepare;
