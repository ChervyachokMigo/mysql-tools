...
const import_prepare = (_a) => __awaiter(void 0, [_a], void 0, function* ({ DB_HOST, DB_PORT, DB_USER, DB_PASSWORD, DATABASES }) {
    ...
    try {
        ...
        (0, scores_1.scores_prepare)(tests_connection, tests_connection);
        (0, twitchchat_1.twitchchat_prepare)(tests_connection, tests_connection, tests_connection);
        (0, webserver_1.webserver_prepare)(tests_connection);
