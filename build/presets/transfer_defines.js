...
exports.transferprepare = void 0;
const mysql_tools_1 = require("mysql-tools");
const beatmaps_1 = require("../preparations/beatmaps");
const transferprepare = (_a) => __awaiter(void 0, [_a], void 0, function* ({ DB_HOST, DB_PORT, DB_USER, DB_PASSWORD, DATABASES }) {
    var _b, _c, _d, _e, _f, _g, _h, _j;
    try {
        const MYSQL_CREDENTIALS = { DB_HOST, DB_PORT, DB_USER, DB_PASSWORD, DATABASES };
        const connections = yield (0, mysql_tools_1.prepareDB)(MYSQL_CREDENTIALS);
        ...
        (0, beatmaps_1.beatmapsprepare)(beatmaps_connection);
        /*telegramprepare(telegram_connection, beatmaps_connection);
        discordprepare(discord_connection, twitchchat_connection);
        scoresprepare(scores_connection, beatmaps_connection);
        twitchchatprepare(twitchchat_connection, discord_connection, beatmaps_connection);
        webserverprepare(webserver_connection);*/
        yield (0, mysql_tools_1.prepareEND)();
    }
    catch (e) {
        console.error(e);
        throw new Error(e);
...
exports.transferprepare = transferprepare;
