...
export declare const MYSQL_UPDATE: (action?: string | null, condition?: WhereOptions, values?: any) => Promise<any>;
export declare const MYSQL_DELETE: (action?: string | null, condition?: WhereOptions) => Promise<any>;
