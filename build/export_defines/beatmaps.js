...
exports.beatmaps_defines = void 0;
...
const beatmaps_defines = (connection) => {
    if (typeof connection === 'undefined') {
        throw new Error('no connection in beatmaps_defines');
    }
    const model = {
...
exports.beatmaps_defines = beatmaps_defines;
