...
exports.scores_defines = void 0;
const score_legacy_1 = require("../mysql_models/scores/score_legacy");
const score_1 = require("../mysql_models/scores/score");
const user_grade_1 = require("../mysql_models/scores/user_grade");
const beatmaps_md5_1 = require("../mysql_models/beatmaps/beatmaps_md5");
const scores_defines = (score_connection, beatmap_connection) => {
    if (typeof score_connection === 'undefined' || typeof beatmap_connection === 'undefined') {
        throw new Error('no connection in scores_defines');
    }
    const model = {
...
exports.scores_defines = scores_defines;
