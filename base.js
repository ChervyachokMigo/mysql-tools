...
module.exports = {
    ...
    MYSQL_GET_ALL: async ({ action, params = {}, attributes = undefined, limit = null, order = null }) => {
        const MysqlModel = select_mysql_model(action);
    ...
    MYSQL_UPDATE: async (action, condition = null, values = {}) => {
        const MysqlModel = select_mysql_model(action);
    ...
    MYSQL_DELETE: async (action, condition = null) => {
        const MysqlModel = select_mysql_model(action);
    ...
    MYSQL_SAVE: async ( action, condition, values, ignore_duplicates = true ) => {
        const MysqlModel = select_mysql_model(action);
